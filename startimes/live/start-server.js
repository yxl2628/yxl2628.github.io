...
function processRequest(request, response) {
  ...
  if (pathName.indexOf('/getHls/') >= 0) {
    const id = pathName.split('/')[2]
    cp.exec('/home/houmr/video/ke/start.sh ' + videoList[id - 1].url + ' &', function() {
      console.log('切换视频，执行脚本#', '/home/houmr/video/ke/start.sh ' + videoList[id - 1].url + ' &')
    })
  }
  //对路径解码，防止中文乱码
